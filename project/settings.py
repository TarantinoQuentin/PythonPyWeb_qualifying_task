...
SECRET_KEY = 'django-insecure-%!^(uv%br2pt9uy4nb7^jf-rybfvird*#l(abv%59cl%k2+ydr'
...
AUTH_USER_MODEL = 'api_educational_courses.User'
...
# Чтобы была возможность обрабатывать формы при https протоколе
